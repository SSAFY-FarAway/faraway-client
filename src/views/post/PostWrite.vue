<template>
  ...
  >
    ...
    <div class="row m-0 mt-3">
      <input type="text" class="form-control font-weight-bold " id="title" style="font-size : 1.2em" v-model="request.title" placeholder="제목을 입력해주세요."/>
    </div>
    ...
    <div class="row p-0 m-0 justify-content-end">
      <router-link to="/post/list" class="btn btn-secondary">
        목록으로
      </router-link>
