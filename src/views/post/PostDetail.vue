            ...
            <div class="row justify-content-center">
              <div class="container" id="article-view-section">
                <div class="row justify-content-center">
                  ...
                  <div
                    class="col-lg-8 col-md-10 col-sm-12 bg-white border rounded-3 shadow"
                  >
                    <div class="row my-2">
                      <h2 id="title" class="px-5">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="clearfix align-content-center">
                          <img
                            class="avatar md-start bg-light p-2"
                            src="https://raw.githubusercontent.com/twbs/icons/main/icons/person-fill.svg"
                          />
                          <span id="member-id" class="p-2 fw-bold"
                            >작성자 : {{ post.loginId }}</span
                          >
                          <p>
                            <span
                              id="created-date"
                              ...
                              >작성일 :
                              {{ post.createdDate | timeFilter }}</span
                            >
                      ...
                      <div class="mt-3">
                        <ul>
                          ...
                          >
                            ...
                            <a
                              :href="
                                'http://localhost/attachment/download/' +
                                attachment.id
                              "
                            >
                              [다운로드]
...
export default {
  ...
  created() {
    http.get(`/post/${this.$route.params.postId}`).then((response) => {
  ...
  methods: {
    ...
    deletePost() {
      if (confirm("삭제하시겠습니까? 삭제된 글은 복구할 수 없습니다.")) {
        http.delete(`/post/${this.$route.params.postId}`).then((response) => {
